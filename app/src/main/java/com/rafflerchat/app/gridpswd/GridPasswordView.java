package com.rafflerchat.app.gridpswd;
...
public class GridPasswordView extends LinearLayout implements PasswordView {
    ...
    private void inflaterViews(Context context) {
        ...
        inflater.inflate(R.layout.layout_gridpswd_view, this);
        ...
        font = Typeface.createFromAsset(context.getResources().getAssets(), "fonts/helvetica_rounded_bold.otf");
        mInputView.setTypeface(font);
        mInputView.setBackgroundResource(R.drawable.border_line_bottom);
        ...
        while (index < mPasswordLength) {
            View dividerView = inflater.inflate(R.layout.layout_gridpswd_divider, null);
            ...
            TextView textView = (TextView) inflater.inflate(R.layout.layout_gridpswd_textview, null);
            setCustomAttr(textView);
            textView.setTypeface(font);
            textView.setBackgroundResource(R.drawable.border_line_bottom);
